...
static void int_pipe_truncate (INT_PARAMS); /* 43 */
static void int_pipe_open_stream (INT_PARAMS); /* 44 */
static void int_time_get (INT_PARAMS); /* 45 */
static void int_time_wait (INT_PARAMS); /* 46 */
static void int_random (INT_PARAMS); /* 47 */
static void int_memory_copy (INT_PARAMS); /* 48 */
static void int_memory_move (INT_PARAMS); /* 49 */
static void int_memory_set (INT_PARAMS); /* 51 */
...
#define INT_FILE_OPEN_STREAM                          41
#define INT_PIPE_LENGTH                               42
#define INT_PIPE_TRUNCATE                             43
#define INT_PIPE_OPEN_STREAM                          44
#define INT_TIME_GET                                  45
#define INT_TIME_WAIT                                 46
#define INT_RANDOM                                    47
#define INT_MEMORY_COPY                               48
#define INT_MEMORY_MOVE                               49
#define INT_MEMORY_BSET                               50
#define INT_MEMORY_SET                                51
#define INT_STRING_LENGTH                             52
#define INT_STRING_COMPARE                            53
#define INT_NUMBER_TO_STRING                          54
#define INT_FPNUMBER_TO_STRING                        55
#define INT_STRING_TO_NUMBER                          56
#define INT_STRING_TO_FPNUMBER                        57
#define INT_STRING_TO_U16STRING                       58
#define INT_STRING_TO_U32STRING                       59
#define INT_U16STRING_TO_STRING                       60
#define INT_U32STRING_TO_STRING                       61
#define INT_STRING_FORMAT                             62
#define INT_LOAD_FILE                                 63
#define INT_GET_FILE                                  64
#define INTERRUPT_COUNT                               65
...
static void (*(ints[]))(INT_PARAMS) = {
	...
	int_file_open_stream /* 41 */,
	int_pipe_length /* 42 */,
	int_pipe_truncate /* 43 */,
	int_pipe_open_stream /* 44 */,
	int_time_get /* 45 */,
	int_time_wait /* 46 */,
	int_random /* 47 */,
	int_memory_copy /* 48 */,
	...
	int_memory_bset /* 50 */,
	int_memory_set /* 51 */,
	int_string_length /* 52 */,
	int_string_compare /* 53 */,
	int_number_to_string /* 54 */,
	int_fpnumber_to_string /* 55 */,
	int_string_to_number /* 56 */,
	int_string_to_fpnumber /* 57 */,
	int_string_to_u16string /* 58 */,
	int_string_to_u32string /* 59 */,
	int_u16string_to_string /* 60 */,
	int_u32string_to_string /* 61 */,
	int_string_format /* 62 */,
	int_load_file /* 63 */,
	int_get_file /* 64 */,
};
