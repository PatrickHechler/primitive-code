...
:
	(
		HEX_SYMBOL hexnum
		{$num = new de.hechler.patrick.codesprachen.primitive.compile.objects.num.DirectNum(Long.parseLong($hexnum.getText(), 10));}

	)
	|
	(
		DEC_SYMBOL decnum
		{$num = new de.hechler.patrick.codesprachen.primitive.compile.objects.num.DirectNum(Long.parseLong($decnum.getText(), 10));}

	)
	|
	(
		BIN_SYMBOL binnum
		{$num = new de.hechler.patrick.codesprachen.primitive.compile.objects.num.DirectNum(Long.parseLong($binnum.getText(), 2));}
