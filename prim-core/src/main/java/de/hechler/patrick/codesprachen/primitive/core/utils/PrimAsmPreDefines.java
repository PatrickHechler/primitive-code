...
public class PrimAsmPreDefines {
	 ...
	 * params:
	 * <ul>
	 * <li><code>X00</code> <code>old_mem</code>: (<code>ubyte#</code>) points to the old memory-block</li>
	 * <li><code>X01</code> <code>new_len</code>: (<code>unum</code>) the new size of the memory-block</li>
	 * </ul>
	 * result values:
	 * <ul>
	 * <li><code>X01</code> <code>new_mem</code>: (<code>ubyte#</code>) points to the new memory-block or <code>-1</code> on error</li>
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	 ...
	 * params:
	 * <ul>
	 * <li><code>X00</code> <code>file_name</code>: (<code>char#</code>) the STRING, which refers to the file which should be read</li>
	 * <li><code>X01</code> <code>mode</code>: (<code>unum</code>) the open mode (bitwise OR of the options)</li>
	 * </ul>
	 * result values:
	 * <ul>
	 ...
	 * <li><code>X02</code> <code>data</code>: (<code>ubyte#</code>) points to the elements to write</li>
	 * </ul>
	 * result values:
	 * <ul>
	 ...
	 * <li><code>X02</code> <code>data</code>: (<code>ubyte#</code>) points to the elements to read</li>
	 * </ul>
	 * result values:
	 * <ul>
