...
public class PrimAsmPreDefines {
	 ...
	 * the <code>INTCNT</code> register is initialed with this value<br>
	 */
	 ...
	 * <p>
	 * this floating point constant holds a NaN value<br>
	 */
	 ...
	 * <p>
	 * the minimum not infinite floating point value<br>
	 */
	 ...
	 * <p>
	 * the floating point constant for positive infinity<br>
	 */
	 ...
	 * <p>
	 * the floating point constant for negative infinity<br>
	 */
	 ...
	 * <p>
	 * the start address of the register memory block<br>
	 */
	 ...
	 * this constant has the same value as the <code>REGISTER_MEMORY_START</code> constant<br>
	 */
	 ...
	 * value: <code>0x0000000000001008</code>
	 * <p>
	 * the start address of the <code>SP</code> register<br>
	 */
	 ...
	 * <p>
	 * the start address of the <code>INTP</code> register<br>
	 */
	 ...
	 * <p>
	 * the start address of the <code>STATUS</code> register<br>
	 */
	 ...
	 * <p>
	 * the start address of the <code>ERRNO</code> register<br>
	 */
	 ...
	 * the address of a <code>XNN</code> register can be calculated by multiplying the register number and adding this constant<br>
	 */
	 ...
	 * <p>
	 * this constant holds the last valid address of the registers<br>
	 */
	 ...
	 * <p>
	 * this constant holds the lowest address, which is above the register memory block<br>
	 */
	 ...
	 * <p>
	 * this constant holds the maximum number value<br>
	 */
	 ...
	 * <p>
	 * this constant holds the minimum number value<br>
	 */
	 ...
	 * write and seek operations on the <i>STDIN</i> stream will fail<br>
	 */
	 ...
	 * read and seek operations on the <i>STDOUT</i> stream will fail<br>
	 */
	 ...
	 * the stream is initially open for writing<br>
	 * read and seek operations on the <i>STDLOG</i> stream will fail<br>
	 */
	 ...
	 * after handling the error the <code>ERRNO</code> register should be set to this value<br>
	 */
	 ...
	 * this error value is the least helpful value for error handling<br>
	 */
	 ...
	 * value: <code>2</code>
	 * <p>
	 * this error value is used when an iterator was used too often<br>
	 */
	 ...
	 * for example when an file is asked how many children it has<br>
	 */
	 ...
	 * value: <code>4</code>
	 * <p>
	 * this error value indicates that some element does not exist<br>
	 */
	 ...
	 * value: <code>5</code>
	 * <p>
	 * this error value indicates that an element should be created but it exists already<br>
	 */
	 ...
	 * value: <code>6</code>
	 * <p>
	 * this error value indicates that the file system could not allocate the needed blocks<br>
	 */
	 ...
	 * value: <code>7</code>
	 * <p>
	 * this error value indicates an Input/Output error<br>
	 */
	 ...
	 * value: <code>8</code>
	 * <p>
	 * this error value indicates that some argument has an illegal value<br>
	 */
	 ...
	 * value: <code>9</code>
	 * <p>
	 * this error value indicates that a magic value was invalid<br>
	 */
	 ...
	 * value: <code>10</code>
	 * <p>
	 * this error value indicates that the system could not allocate the needed memory<br>
	 */
	 ...
	 * value: <code>11</code>
	 * <p>
	 * this error value indicates that the root folder restrictions does not allow the tried operation<br>
	 */
	 ...
	 * value: <code>12</code>
	 * <p>
	 * this error value indicates that it was tried to move a folder to one of it's (possibly indirect) children<br>
	 */
	 ...
	 * value: <code>13</code>
	 * <p>
	 * this error value indicates that an element has open multiple handles (more than the used handle)<br>
	 */
	 ...
	 * value: <code>14</code>
	 * <p>
	 * this error value indicates that some value was outside of the allowed range<br>
	 */
	 ...
	 * these flags hold essential information for the file system (for example if an element is a folder)<br>
	 */
	 ...
	 * <p>
	 * this flag is used for all folders<br>
	 */
	 ...
	 * <p>
	 * this flag is used for all files<br>
	 */
	 ...
	 * <p>
	 * this flag is used for all pipes<br>
	 */
	 ...
	 * <p>
	 * this flag is used to indicate, that a file can be executed<br>
	 */
	 ...
	 * <p>
	 * this flag is used to indicate, that an element should be hidden<br>
	 */
	 ...
	 * when used the <code>STREAM_FILE</code> or <code>STREAM_PIPE</code> flag has to be set<br>
	 */
	 ...
	 * when used the <code>STREAM_PIPE</code> flag is not allowed<br>
	 */
	 ...
	 * when used the <code>STREAM_FILE</code> flag is not allowed<br>
	 */
	 ...
	 * value: <code>0x00000100</code>
	 * <p>
	 * used to open a stream, which support the use of the read operations<br>
	 */
	 ...
	 * for pipes the <code>STREAM_WRITE</code> flag is equally to this flag<br>
	 */
	 ...
	 * this flag can be used only with file streams<br>
	 */
