...
public class PrimAsmPreDefines {
	 ...
	 * </ul>
	 * on error <code>ERRNO</code> will be set to a non-zero value<br>
	 * note that <code>mem</code> will be 8 byte aligned<br>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	 ...
	 * </ul>
	 * on error <code>ERRNO</code> will be set to a non-zero value<br>
	 * note that <code>newMem</code> will be 8 byte aligned<br>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	...
	/**
	 * <b>INT_ELEMENT_CLOSE</b>: close element handle<br>
	 * value: <code>20</code>
	 * <p>
	 * params:
	 * <ul>
	 * <li><code>X00</code> <code>id</code>: (<code>num</code>) the ELEMENT-ID to be closed</li>
	 * </ul>
	 * note that <code>id</code> will always be released (if valid), even if the operation fails<br>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_ELEMENT_CLOSE = 20L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_ELEMENT_OPEN_PARENT = 21L;
	/**
	 ...
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_ELEMENT_GET_CREATE = 22L;
	/**
	 ...
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_ELEMENT_GET_LAST_MOD = 23L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_ELEMENT_SET_CREATE = 24L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_ELEMENT_SET_LAST_MOD = 25L;
	/**
	 ...
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_ELEMENT_DELETE = 26L;
	/**
	 ...
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_ELEMENT_MOVE = 27L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_ELEMENT_GET_NAME = 28L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_ELEMENT_GET_PATH = 29L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_ELEMENT_GET_FS_PATH = 30L;
	/**
	 ...
	 * result values:
	 * <ul>
	 * <li><code>X01</code> <code>mountId</code>: (<code>num</code>) will be set to the ELEMENT-ID of the mount point</li>
	 * </ul>
	 * the first parent element wich has the <code>FLAG_MOUNT</code> flag set will be returned in <code>mountId</code>
	 * <ul>
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_ELEMENT_GET_MOUNT = 31L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_ELEMENT_GET_FLAGS = 32L;
	/**
	 ...
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_ELEMENT_MODIFY_FLAGS = 33L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_FOLDER_CHILD_COUNT = 34L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_FOLDER_OPEN_CHILD_OF_NAME = 35L;
	/**
	 ...
	 * </ul>
	 * this operation will fail if the child is no folder or mount point<br>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_FOLDER_OPEN_CHILD_FOLDER_OF_NAME = 36L;
	/**
	 * <b>INT_FOLDER_OPEN_CHILD_MOUNT_OF_NAME</b>: folder get child mount point of name<br>
	 * value: <code>37</code>
	 * <p>
	 * params:
	 * <ul>
	 ...
	 * <li><code>X01</code> <code>childId</code>: (<code>num</code>) the newly opened (FOLDER-)ELEMENT-ID for the child or <code>-1</code> on error</li>
	 * </ul>
	 * this operation will fail if the child is no mount point<br>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_FOLDER_OPEN_CHILD_MOUNT_OF_NAME = 37L;
	/**
	 ...
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_FOLDER_OPEN_CHILD_FILE_OF_NAME = 38L;
	/**
	 ...
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_FOLDER_OPEN_CHILD_PIPE_OF_NAME = 39L;
	/**
	 * <b>INT_FOLDER_OPEN_DESC_OF_PATH</b>: folder get descendant of path<br>
	 * value: <code>40</code>
	 * <p>
	 * params:
	 * <ul>
	 * <li><code>X00</code> <code>id</code>: (<code>num</code>) the (FOLDER-)ELEMENT-ID</li>
	 * <li><code>X01</code> <code>path</code>: (<code>char#</code>) points to a STRING with the relative path of the descendant</li>
	 * </ul>
	 * result values:
	 * <ul>
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_FOLDER_OPEN_DESC_OF_PATH = 40L;
	/**
	 * <b>INT_FOLDER_OPEN_DESC_FOLDER_OF_PATH</b>: folder get descendant folder of path<br>
	 * value: <code>41</code>
	 * <p>
	 * params:
	 * <ul>
	 ...
	 * result values:
	 * <ul>
	 * <li><code>X01</code> <code>descId</code>: (<code>num</code>) the newly opened (PIPE-)ELEMENT-ID for the descendant or <code>-1</code> on error</li>
	 * </ul>
	 * this operation will fail if the descendant is no folder or mount point<br>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_FOLDER_OPEN_DESC_FOLDER_OF_PATH = 41L;
	/**
	 * <b>INT_FOLDER_OPEN_DESC_MOUNT_OF_PATH</b>: folder get descendant mount point of path<br>
	 * value: <code>42</code>
	 * <p>
	 * params:
	 * <ul>
	 ...
	 * <li><code>X01</code> <code>descId</code>: (<code>num</code>) the newly opened (PIPE-)ELEMENT-ID for the descendant or <code>-1</code> on error</li>
	 * </ul>
	 * this operation will fail if the descendant is no mount point<br>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_FOLDER_OPEN_DESC_MOUNT_OF_PATH = 42L;
	/**
	 * <b>INT_FOLDER_OPEN_DESC_FILE_OF_PATH</b>: folder get descendant file of path<br>
	 * value: <code>43</code>
	 * <p>
	 * params:
	 * <ul>
	 ...
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_FOLDER_OPEN_DESC_FILE_OF_PATH = 43L;
	/**
	 * <b>INT_FOLDER_OPEN_DESC_PIPE_OF_PATH</b>: folder get descendant pipe of path<br>
	 * value: <code>44</code>
	 * <p>
	 * params:
	 * <ul>
	 ...
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_FOLDER_OPEN_DESC_PIPE_OF_PATH = 44L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_FOLDER_CREATE_CHILD_FOLDER = 45L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_FOLDER_CREATE_CHILD_FILE = 46L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_FOLDER_CREATE_CHILD_PIPE = 47L;
	/**
	 * <b>INT_FOLDER_CREATE_CHILD_MOUNT_TMP</b>: folder add temp mount pipe<br>
	 * value: <code>48</code>
	 * <p>
	 * params:
	 * <ul>
	 * <li><code>X00</code> <code>id</code>: (<code>num</code>) the (FOLDER-)ELEMENT-ID</li>
	 * <li><code>X01</code> <code>name</code>: (<code>char#</code>) points to the STRING name of the new child element</li>
	 * <li><code>X02</code> <code>blockCount</code>: (<code>num</code>) the number of blocks available to the file system</li>
	 * <li><code>X03</code> <code>blockSize</code>: (<code>num</code>) the size of each block of the file system</li>
	 * </ul>
	 * result values:
	 * <ul>
	 * <li><code>X01</code> <code>childId</code>: (<code>num</code>) will be set to a newly created/opened (PIPE-)ELEMENT-ID for the child or <code>-1</code> on error</li>
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_FOLDER_CREATE_CHILD_MOUNT_TMP = 48L;
	/**
	 * <b>INT_FOLDER_CREATE_CHILD_MOUNT_INTERN</b>: folder add intern mount pipe<br>
	 * value: <code>49</code>
	 * <p>
	 * params:
	 * <ul>
	 * <li><code>X00</code> <code>id</code>: (<code>num</code>) the (FOLDER-)ELEMENT-ID</li>
	 * <li><code>X01</code> <code>name</code>: (<code>char#</code>) points to the STRING name of the new child element</li>
	 * <li><code>X02</code> <code>blockCount</code>: (<code>num</code>) the maximum number of blocks available to the file system</li>
	 * <li><code>X03</code> <code>blockSize</code>: (<code>num</code>) the size of each block of the file system</li>
	 * </ul>
	 * result values:
	 * <ul>
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_FOLDER_CREATE_CHILD_MOUNT_INTERN = 49L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_FOLDER_OPEN_ITER = 50L;
	/**
	 * <b>INT_FOLDER_ITER_CLOSE</b>: close folder child iterator<br>
	 * value: <code>51</code>
	 * <p>
	 * params:
	 * <ul>
	 * <li><code>X00</code> <code>id</code>: (<code>num</code>) the ITERATOR-ID</li>
	 * </ul>
	 * note that <code>id</code> will always be released (if valid), even if the operation fails<br>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_FOLDER_ITER_CLOSE = 51L;
	/**
	 * <b>INT_FOLDER_ITER_NEXT</b>: get next of the folder child iterator<br>
	 * value: <code>52</code>
	 * <p>
	 * params:
	 * <ul>
	 ...
	 * result values:
	 * <ul>
	 * <li><code>X00</code> <code>child_id</code>: (<code>num</code>) the ELEMENT-ID of the next/current child or <code>-1</code> on error</li>
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_FOLDER_ITER_NEXT = 52L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_FILE_LENGTH = 53L;
	/**
	 ...
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_FILE_TRUNCATE = 54L;
	/**
	 ...
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_HANDLE_OPEN_STREAM = 55L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_PIPE_LENGTH = 56L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_TIME_GET = 57L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_TIME_RES = 58L;
	/**
	 ...
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_TIME_SLEEP = 59L;
	/**
	 ...
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_TIME_WAIT = 60L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_RND_OPEN = 61L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_RND_NUM = 62L;
	/**
	 ...
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_MEM_CMP = 63L;
	/**
	 ...
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_MEM_CPY = 64L;
	/**
	 ...
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_MEM_MOV = 65L;
	/**
	 ...
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_MEM_BSET = 66L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_STR_LEN = 67L;
	/**
	 ...
	 * <ul>
	 * <li><code>X00</code> <code>str</code>: (<code>char#</code>) points to the STRING</li>
	 * <li><code>X01</code> <code>chr</code>: (<code>char</code>) the character to search</li>
	 * </ul>
	 * result values:
	 * <ul>
	 ...
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_STR_INDEX = 68L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_STR_CMP = 69L;
	/**
	 ...
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_STR_FROM_NUM = 70L;
	/**
	 ...
	 * the new length will be the old length or if the old length is smaller than the size of the STRING (with <code>\0</code>) than the size of the STRING (with <code>\0</code>)<br>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_STR_FROM_FPNUM = 71L;
	/**
	 ...
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_STR_TO_NUM = 72L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_STR_TO_FPNUM = 73L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_STR_TO_U16STR = 74L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_STR_TO_U32STR = 75L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_STR_FROM_U16STR = 76L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_STR_FROM_U32STR = 77L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_STR_FORMAT = 78L;
	/**
	 ...
	 * </ul>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_LOAD_FILE = 79L;
	/**
	 ...
	 * <li><code>X02</code> <code>initIsPntr</code>: (<code>num</code>) non-<code>0</code> if the <code>initOff</code> only holds the offset of the offset of the init function and <code>0</code> if <code>initOff</code> holds the offset of the init function</li>
	 * </ul>
	 * result values:
	 * <ul>
	 * <li><code>X00</code> <code>data</code>: (<code>ubyte#</code>) points to the memory block, in which the libary has been loaded</li>
	 * <li><code>X01</code> <code>len</code>: (<code>num</code>) the length of the libary (and the memory block)</li>
	 * <li><code>X02</code> <code>loaded</code>: (<code>num</code>) <code>1</code> if the libary has been loaded as result of this interrupt and <code>0</code> if the file was already loaded</li>
	 * </ul>
	 ...
	 * <ul>
	 * <li>a <code>CALL</code> is done with <code>X00 + initOff</code> as target</li>
	 * <li><code>initOff</code> points to the initialisation function (relative from the file start)</li>
	 * </ul></li>
	 * <li>if <code>initIsPntr</code> is set to a value other than <code>0</code>
	 * <ul>
	 * <li>if <code>[X00 + initOff]</code> is <code>-1</code> no call is done</li>
	 * <li>otherwise a <code>CALL</code> is done with <code>X00 + [X00 + initOff]</code> as target</li>
	 * <li><code>initOff</code> points to the address where the offset of the initialisation function is stored
	 * <ul>
	 * <li>both are relative from the file start</li>
	 * </ul></li>
	 * </ul></li>
	 * <li>note that the initialisation function may set the result values
	 * <ul>
	 * <li>when this is unacceptable <code>initOff</code> should be set to <code>-1</code></li>
	 * <li>note that only the <code>IP</code> is saved on the stack when calling the initialisation function</li>
	 * </ul></li>
	 * </ol>
	 ...
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_LOAD_LIB = 80L;
	/**
	 ...
	 * params:
	 * <ul>
	 * <li><code>X00</code> <code>file</code>: (<code>char#</code>) is set to the name of the libary</li>
	 * <li><code>X01</code> <code>mem</code>: (<code>ubyte#</code>) the normal memory block which should be converted to a lobary memory block</li>
	 * </ul>
	 * result values:
	 * <ul>
	 * <li><code>X00</code> <code>data</code>: (<code>ubyte#</code>) points to the memory block, in which the libary has been loaded</li>
	 * <li><code>X01</code> <code>len</code>: (<code>num</code>) the length of the libary (and the memory block)</li>
	 * <li><code>X02</code> <code>loaded</code>: (<code>num</code>) <code>1</code> if the libary has been loaded/converted as result of this interrupt and <code>0</code> if the libary was already loaded</li>
	 * </ul>
	 * if <code>loaded</code> is <code>0</code> <code>mem</code> will not be converted to a libary memory block<br>
	 * by using this interrupt the program can convert a normal memory block to a libary memory block<br>
	 * when an error occurred <code>X01</code> will be set to <code>-1</code>, <code>X00</code> will be unmodified and <code>ERRNO</code> will be set to a non-zero value<br>
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_CREATE_LIB = 81L;
	/**
	 ...
	 * params:
	 * <ul>
	 * <li><code>X00</code> <code>data</code>: (<code>ubyte#</code>) points to the start of the memory block loaded with <code>INT_LOAD_LIB</code> or converted with <code>INT_CREATE_LIB</code></li>
	 * </ul>
	 ...
	 * this value can be used by the <code>INT</code> command to indicate that this interrupt should be called	 */
	public static final long INT_UNLOAD_LIB = 82L;
	/**
	...
	public static final long INTERRUPT_COUNT = 83L;
	/**
