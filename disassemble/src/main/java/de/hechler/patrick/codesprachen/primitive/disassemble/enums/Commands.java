...
public enum Commands {
	...
	CMD_MODFP(ParamArt.TWO_PARAMS_P1_NO_CONST_P2_ALLOW_CONST, MODFP),
	CMD_ADDQFP(ParamArt.TWO_PARAMS_P1_NO_CONST_P2_ALLOW_CONST, ADDQFP),
	CMD_SUBQFP(ParamArt.TWO_PARAMS_P1_NO_CONST_P2_ALLOW_CONST, SUBQFP),
	CMD_MULQFP(ParamArt.TWO_PARAMS_P1_NO_CONST_P2_ALLOW_CONST, MULQFP),
	CMD_DIVQFP(ParamArt.TWO_PARAMS_P1_NO_CONST_P2_ALLOW_CONST, DIVQFP),
	CMD_MODQFP(ParamArt.TWO_PARAMS_P1_NO_CONST_P2_ALLOW_CONST, MODQFP),
	CMD_ADDSFP(ParamArt.TWO_PARAMS_P1_NO_CONST_P2_ALLOW_CONST, ADDSFP),
	CMD_SUBSFP(ParamArt.TWO_PARAMS_P1_NO_CONST_P2_ALLOW_CONST, SUBSFP),
	CMD_MULSFP(ParamArt.TWO_PARAMS_P1_NO_CONST_P2_ALLOW_CONST, MULSFP),
	CMD_DIVSFP(ParamArt.TWO_PARAMS_P1_NO_CONST_P2_ALLOW_CONST, DIVSFP),
	CMD_MODSFP(ParamArt.TWO_PARAMS_P1_NO_CONST_P2_ALLOW_CONST, MODSFP),
	...
	CMD_BCP(ParamArt.TWO_PARAMS_ALLOW_CONSTS, BCP),
	CMD_CMPFP(ParamArt.TWO_PARAMS_ALLOW_CONSTS, CMPFP),
	CMD_CMPSFP(ParamArt.TWO_PARAMS_ALLOW_CONSTS, CMPSFP),
	CMD_CMPQFP(ParamArt.TWO_PARAMS_ALLOW_CONSTS, CMPQFP),
	...
	CMD_JMPO(ParamArt.TWO_PARAMS_P1_NO_CONST_P2_COMPILE_CONST, JMPO),
	...
	CMD_NEGQFP(ParamArt.ONE_PARAM_NO_CONST, NEGQFP),
	CMD_NEGSFP(ParamArt.ONE_PARAM_NO_CONST, NEGSFP),
	...
	CMD_CHKQFP(ParamArt.ONE_PARAM_ALLOW_CONST, CHKQFP),
	CMD_CHKSFP(ParamArt.ONE_PARAM_ALLOW_CONST, CHKSFP),
	CMD_SGN(ParamArt.ONE_PARAM_ALLOW_CONST, SGN),
	CMD_SGNFP(ParamArt.ONE_PARAM_ALLOW_CONST, SGNFP),
	CMD_SGNSFP(ParamArt.ONE_PARAM_ALLOW_CONST, SGNSFP),
	CMD_SGNQFP(ParamArt.ONE_PARAM_ALLOW_CONST, SGNQFP),
	CMD_JMPNO(ParamArt.ONE_PARAM_ALLOW_CONST, JMPNO),
	CMD_INT(ParamArt.ONE_PARAM_ALLOW_CONST, INT),
	CMD_CALNO(ParamArt.ONE_PARAM_ALLOW_CONST, CALNO),
