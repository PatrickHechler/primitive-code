...
public enum Commands {
	...
	CMD_JMP(0x10), CMD_JMPEQ(0x11), CMD_JMPNE(0x12), CMD_JMPGT(0x13), CMD_JMPGE(0x14), CMD_JMPLT(0x15), CMD_JMPLE(0x16), CMD_JMPCS(0x17), CMD_JMPCC(0x18),
	CMD_JMPZS(0x19), CMD_JMPZC(0x1A), CMD_JMPNAN(0x1B), CMD_JMPAN(0x1C),
	...
	CMD_IRET(0x26),
	CMD_SWAP(0x27), CMD_LEA(0x28), CMD_MVAD(0x29),
	CMD_CALO(0x2A),
